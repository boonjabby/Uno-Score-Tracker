const CACHE_NAME = 'uno-tracker-v5.0.0';
const RUNTIME_CACHE = 'uno-tracker-runtime-v5';
const ASSETS = [
  './', './index.html', './styles.css', './app.js', './manifest.json',
  './live-sync.js', './v5-features.js', './firebase-config.js', './CHANGELOG.md', './CURRENT-STATE-v4.7.md', './icons/icon-192.png', './icons/icon-512.png'
];
